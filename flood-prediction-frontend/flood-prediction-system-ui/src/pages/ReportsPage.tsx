...
import { getReports, sendToPowerBI } from '../services/api'
...
export function ReportsPage() {
  ...
  const district = useDebounce(districtInput, 300)

  const reports = useAsync(
    () => getReports({ date: date || undefined, district: district || undefined }),
    [date, district],
  )
